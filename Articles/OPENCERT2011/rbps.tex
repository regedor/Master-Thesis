...
We can call those natural standards: best practices. 
...
but contrary to the companies coding standards and rules, which work in a top down system, 
best practices happen in a bottom up and distributive system, 
...
The results of traffic lights is more easy to predict, it is a regulation that system 
doesn't depend much on the driver skills,
but because is so restrictive it will happen often to find drivers stooped, alone, losing precious time, 
at the crossroads waiting for a green light.
On the other side, the roundabout is a less restricted system, it 
depends much more on the quality of the drivers, 
but it open the possibility to a much more efficient traffic jam.
